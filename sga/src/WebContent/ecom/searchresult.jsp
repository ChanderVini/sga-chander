...
--%>
<%@ page import="com.myappsecurity.sga.vo.SearchVO" %>
<%@ include file="../common/header.jsp"%>
<% 
    SearchVO[] productVOs =  (SearchVO[])session.getAttribute ("PRODUCTS");
%>
<html>
    <head>
                    ...
                    <table class="contentTable" cellpadding="2" cellspacing="1">
                        <thead>
                            <tr>
                                ...
                                <td align="left">
                                    <%=productVOs[cnt].getProductName()%>
                                </td>
                                <td align="left">
                                    <%=productVOs[cnt].getDescription()%>
                                </td>
                                <td align="left">
                                    <%=productVOs[cnt].getProductPrice()%>
                                </td>
                                <td align="left">
                                    <%=productVOs[cnt].getProductImg()%>
                                </td>
                            </tr>
                        <%
                                }
