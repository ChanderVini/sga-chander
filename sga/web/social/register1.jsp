...
<%-- 
    Document   : register1
    Created on : Apr 23, 2008, 8:28:34 AM
...
<%@ page import="com.myappsecurity.sga.vo.UserVO"%>
    <head>
        <% 
            String action = actionprefix + "/registersub";
        ...
        <title>Registeration Page (Step 1)</title>
    </head>
    <body>
        <%@ include file="../common/menu.jsp"%>
        <form name="register1" action="<%=action%>" method="post">                
                     ...
                     <td align="center">
                        <table class="contentTable" cellpadding="2" cellspacing="1">
                            ...
                            <tr class="dataGridRowDark">
                                ...
                                <td align="left">
                                    <input type="password" name="userPassword" class="edittextfield" onblur="checkpass(this)">
                                     <%
